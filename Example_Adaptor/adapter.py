# coding: utf-8
# Delft-FEWS adapter for iMOD groundwater models
# Martijn Visser, Deltares, 2018-08
...
# determine how we get the timestep, from mapstacks? assume day?
...
def post_adapter():
    print("Running iMOD Delft-FEWS post adapter")
    run_info = read_run_info(run_info_file)
    properties = run_info["properties"]
    ...
    waterbalance(run_info)
    # save a subset of the model output grids as a NetCDF,
    # to be imported into Delft-FEWS
    write_grid_netcdf(run_info)
...
if __name__ == "__main__":
    ...
    # TODO add help text
    parser = argparse.ArgumentParser(description="Delft-FEWS adapter for iMOD models")
    ...
    help_pos = "Set the output states from Delft-FEWS"
